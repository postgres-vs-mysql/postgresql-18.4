...
impl<E0, E1, M0: Copy, M1: Copy, A: Accessor2<E0, E1, M0, M1>> Accessor2<E0, E1, M0, M1> for (A,) {
    ...
    #[inline(always)]
    fn push(&mut self, input: &[E0], target: &[E1]) {
        let _guard = trace_guard!("Accessor2((A,))::push [rust]");
        self.0.push(input, target);
    }

    #[inline(always)]
    fn finish(self, input: M0, target: M1) -> Self::Output {
        let _guard = trace_guard!("Accessor2((A,))::finish [rust]");
    ...
    Accessor2<E0, E1, M0, M1> for (A, B)
{
    ...
    #[inline(always)]
    fn push(&mut self, input: &[E0], target: &[E1]) {
        let _guard = trace_guard!("Accessor2((A, B))::push [rust]");
        self.0.push(input, target);
    ...
    #[inline(always)]
    fn finish(self, input: M0, target: M1) -> Self::Output {
        let _guard = trace_guard!("Accessor2((A, B))::finish [rust]");
    ...
    A: Accessor1<E, M>,
{
    ...
    #[inline(always)]
    fn push(&mut self, input: &[E]) {
        let _guard = trace_guard!("Accessor1((A,))::push [rust]");
        self.0.push(input);
    }

    #[inline(always)]
    fn finish(self, input: M) -> Self::Output {
        let _guard = trace_guard!("Accessor1((A,))::finish [rust]");
        (self.0.finish(input),)
    }
}
    ...
    B: Accessor1<E, M>,
{
    ...
    #[inline(always)]
    fn push(&mut self, input: &[E]) {
        let _guard = trace_guard!("Accessor1((A, B))::push [rust]");
        self.0.push(input);
        self.1.push(input);
    }
    ...
    #[inline(always)]
    fn finish(self, input: M) -> Self::Output {
        let _guard = trace_guard!("Accessor1((A, B))::finish [rust]");
    ...
    F: FnOnce(T, M) -> R,
{
    ...
    #[inline(always)]
    fn push(&mut self, input: &[E]) {
        let _guard = trace_guard!("Accessor1(FunctionalAccessor<T, P, F>)::push [rust]");
        (self.p)(&mut self.data, input);
    }

    #[inline(always)]
    fn finish(self, input: M) -> Self::Output {
        let _guard = trace_guard!("Accessor1(FunctionalAccessor<T, P, F>)::finish [rust]");
...
impl<E0, E1, M0, M1, A: Accessor2<E0, E1, M0, M1>> Accessor1<E1, M1> for LAccess<'_, E0, M0, A> {
    ...
    fn push(&mut self, rhs: &[E1]) {
        let _guard = trace_guard!("Accessor1(LAccess<'_, E0, M0, A>)::push [rust]");
    ...
    fn finish(self, rhs: M1) -> Self::Output {
        let _guard = trace_guard!("Accessor1(LAccess<'_, E0, M0, A>)::finish [rust]");
...
impl<E0, E1, M0, M1, A: Accessor2<E0, E1, M0, M1>> Accessor1<E0, M0> for RAccess<'_, E1, M1, A> {
    ...
    fn push(&mut self, lhs: &[E0]) {
        let _guard = trace_guard!("Accessor1(RAccess<'_, E1, M1, A>)::push [rust]");
    ...
    fn finish(self, lhs: M0) -> Self::Output {
        let _guard = trace_guard!("Accessor1(RAccess<'_, E1, M1, A>)::finish [rust]");
        assert!(self.elements.is_empty(), "goal is shorter than expected");
...
impl<E, M: Copy> TryAccessor1<E, M> for () {
    ...
    fn push(&mut self, _: &[E]) -> Option<()> {
        let _guard = trace_guard!("TryAccessor1(())::push [rust]");
        Some(())
    }

    #[inline(always)]
    fn finish(self, _: M) -> Option<Self::Output> {
        let _guard = trace_guard!("TryAccessor1(())::finish [rust]");
        Some(())
    }
}
    ...
    A: TryAccessor1<E, M>,
{
    ...
    #[inline(always)]
    fn push(&mut self, input: &[E]) -> Option<()> {
        let _guard = trace_guard!("TryAccessor1((A,))::push [rust]");
        self.0.push(input)?;
        Some(())
    }
    ...
    #[inline(always)]
    fn finish(self, input: M) -> Option<Self::Output> {
        let _guard = trace_guard!("TryAccessor1((A,))::finish [rust]");
    ...
    B: TryAccessor1<E, M>,
{
    ...
    #[inline(always)]
    fn push(&mut self, input: &[E]) -> Option<()> {
        let _guard = trace_guard!("TryAccessor1((A, B))::push [rust]");
        self.0.push(input)?;
        self.1.push(input)?;
        Some(())
    }
    ...
    #[inline(always)]
    fn finish(self, input: M) -> Option<Self::Output> {
        let _guard = trace_guard!("TryAccessor1((A, B))::finish [rust]");
    ...
    for LTryAccess<'_, E0, M0, A>
{
    ...
    fn push(&mut self, rhs: &[E1]) -> Option<()> {
        let _guard = trace_guard!("TryAccessor1(LTryAccess<'_, E0, M0, A>)::push [rust]");
    ...
    fn finish(self, rhs: M1) -> Option<Self::Output> {
        let _guard = trace_guard!("TryAccessor1(LTryAccess<'_, E0, M0, A>)::finish [rust]");
...
impl<V, D> Default for DistanceAccessor<V, D> {
    #[inline(always)]
    fn default() -> Self {
        let _guard = trace_guard!("Default(DistanceAccessor<V, D>)::default [rust]");
...
impl Accessor2<f32, f32, (), ()> for DistanceAccessor<VectOwned<f32>, L2S> {
    ...
    fn push(&mut self, target: &[f32], input: &[f32]) {
        let _guard = trace_guard!("Accessor2(DistanceAccessor<VectOwned<f32>, L2S>)::push [rust]");
    ...
    fn finish(self, (): (), (): ()) -> Self::Output {
        let _guard =
            trace_guard!("Accessor2(DistanceAccessor<VectOwned<f32>, L2S>)::finish [rust]");
...
impl Accessor2<f32, f32, (), ()> for DistanceAccessor<VectOwned<f32>, Dot> {
    ...
    #[inline(always)]
    fn push(&mut self, target: &[f32], input: &[f32]) {
        let _guard = trace_guard!("Accessor2(DistanceAccessor<VectOwned<f32>, Dot>)::push [rust]");
    ...
    fn finish(self, (): (), (): ()) -> Self::Output {
        let _guard =
            trace_guard!("Accessor2(DistanceAccessor<VectOwned<f32>, Dot>)::finish [rust]");
        Distance::from_f32(-self.0)
    }
}
...
impl Accessor2<f16, f16, (), ()> for DistanceAccessor<VectOwned<f16>, L2S> {
    ...
    fn push(&mut self, target: &[f16], input: &[f16]) {
        let _guard = trace_guard!("Accessor2(DistanceAccessor<VectOwned<f16>, L2S)::push [rust]");
        self.0 += f16::reduce_sum_of_d2(target, input)
    }

    #[inline(always)]
    fn finish(self, (): (), (): ()) -> Self::Output {
        let _guard = trace_guard!("Accessor2(DistanceAccessor<VectOwned<f16>, L2S)::finish [rust]");
        Distance::from_f32(self.0)
    }
}
...
impl Accessor2<f16, f16, (), ()> for DistanceAccessor<VectOwned<f16>, Dot> {
    ...
    #[inline(always)]
    fn push(&mut self, target: &[f16], input: &[f16]) {
        let _guard = trace_guard!("Accessor2(DistanceAccessor<VectOwned<f16>, Dot>)::push [rust]");
    ...
    fn finish(self, (): (), (): ()) -> Self::Output {
        let _guard =
            trace_guard!("Accessor2(DistanceAccessor<VectOwned<f16>, Dot>)::finish [rust]");
        Distance::from_f32(-self.0)
    }
}
...
impl<T: Default> DefaultWithDimension for T {
    fn default_with_dimension(_dim: u32) -> Self {
        let _guard = trace_guard!("DefaultWithDimension(T)::default_with_dimension [rust]");
        Self::default()
    }
}
...
impl<V, D> DefaultWithDimension for ByteDistanceAccessor<V, D> {
    ...
    fn default_with_dimension(dim: u32) -> Self {
        let _guard = trace_guard!(
            "DefaultWithDimension(ByteDistanceAccessor<V, D>)::default_with_dimension [rust]"
        );
...
impl Accessor2<u8, u8, [f32; 4], [f32; 4]> for ByteDistanceAccessor<Rabitq8Owned, L2S> {
    ...
    fn push(&mut self, target: &[u8], input: &[u8]) {
        let _guard =
            trace_guard!("Accessor2(ByteDistanceAccessor<Rabitq8Owned, L2S>)::push [rust]");
    ...
    fn finish(self, target: [f32; 4], input: [f32; 4]) -> Self::Output {
        let _guard =
            trace_guard!("Accessor2(ByteDistanceAccessor<Rabitq8Owned, L2S>)::finish [rust]");
        Distance::from_f32(
...
impl Accessor2<u8, u8, [f32; 4], [f32; 4]> for ByteDistanceAccessor<Rabitq8Owned, Dot> {
    ...
    #[inline(always)]
    fn push(&mut self, target: &[u8], input: &[u8]) {
        let _guard = trace_guard!("Accessor2(ByteDistanceAccessor)::push [rust]");
        self.1 += rabitq::byte::binary::accumulate(target, input);
    }

    #[inline(always)]
    fn finish(self, target: [f32; 4], input: [f32; 4]) -> Self::Output {
        let _guard = trace_guard!("Accessor2(ByteDistanceAccessor)::finish [rust]");
        Distance::from_f32(
...
impl<V, D> DefaultWithDimension for HalfbyteDistanceAccessor<V, D> {
    ...
    fn default_with_dimension(dim: u32) -> Self {
        let _guard = trace_guard!(
            "DefaultWithDimension(HalfbyteDistanceAccessor)::default_with_dimension [rust]"
        );
        Self(dim, 0, PhantomData, PhantomData)
    }
}
...
impl Accessor2<u8, u8, [f32; 4], [f32; 4]> for HalfbyteDistanceAccessor<Rabitq4Owned, L2S> {
    ...
    fn push(&mut self, target: &[u8], input: &[u8]) {
        let _guard =
            trace_guard!("Accessor2(HalfbyteDistanceAccessor<Rabitq4Owned, L2S>)::push [rust]");
    ...
    fn finish(self, target: [f32; 4], input: [f32; 4]) -> Self::Output {
        let _guard =
            trace_guard!("Accessor2(HalfbyteDistanceAccessor<Rabitq4Owned, L2S>)::finish [rust]");
        Distance::from_f32(
...
impl Accessor2<u8, u8, [f32; 4], [f32; 4]> for HalfbyteDistanceAccessor<Rabitq4Owned, Dot> {
    ...
    fn push(&mut self, target: &[u8], input: &[u8]) {
        let _guard =
            trace_guard!("Accessor2(HalfbyteDistanceAccessor<Rabitq4Owned, Dot>)::push [rust]");
        self.1 += rabitq::halfbyte::binary::accumulate(target, input);
    }
    ...
    fn finish(self, target: [f32; 4], input: [f32; 4]) -> Self::Output {
        let _guard =
            trace_guard!("Accessor2(HalfbyteDistanceAccessor<Rabitq4Owned, Dot>)::finish [rust]");
        Distance::from_f32(

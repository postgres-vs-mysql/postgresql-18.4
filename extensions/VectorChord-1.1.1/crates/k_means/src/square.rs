...
impl Square {
    ...
    pub fn with_capacity(d: usize, p: usize) -> Self {
        let _guard = trace_guard!("Square::with_capacity [rust]");
        Self {
            d,
    ...
    pub fn push_slice(&mut self, slice: &[f32]) {
        let _guard = trace_guard!("Square::push_slice [rust]");
    ...
    pub fn copy_within<R: std::ops::RangeBounds<usize>>(&mut self, src: R, dest: usize) {
        let _guard = trace_guard!("Square::copy_within [rust]");
    ...
    pub fn truncate(&mut self, len: usize) {
        let _guard = trace_guard!("Square::truncate [rust]");
        self.p.truncate(self.d * len);
    }
    #[inline]
    pub fn as_mut_view(&mut self) -> SquareMut<'_> {
        let _guard = trace_guard!("Square::as_mut_view [rust]");
        SquareMut {
            d: self.d,
...
impl std::ops::Index<usize> for Square {
    ...
    fn index(&self, index: usize) -> &Self::Output {
        let _guard = trace_guard!("Index(Square)::index [rust]");
...
impl std::ops::IndexMut<usize> for Square {
    fn index_mut(&mut self, index: usize) -> &mut Self::Output {
        let _guard = trace_guard!("IndexMut(Square)::index_mut[rust]");
...
impl<'a> IntoIterator for &'a Square {
    ...
    fn into_iter(self) -> Self::IntoIter {
        let _guard = trace_guard!("IntoIterator(Square)::into_iter [rust]");
...
impl<'a> IntoIterator for &'a mut Square {
    ...
    fn into_iter(self) -> Self::IntoIter {
        let _guard = trace_guard!("IntoIterator(mut Square)::into_iter [rust]");
...
impl<'a> rayon::prelude::IntoParallelIterator for &'a Square {
    ...
    fn into_par_iter(self) -> Self::Iter {
        let _guard = trace_guard!("IntoParallelIterator(Square)::into_par_iter [rust]");
...
impl<'a> rayon::prelude::IntoParallelIterator for &'a mut Square {
    ...
    fn into_par_iter(self) -> Self::Iter {
        let _guard = trace_guard!("IntoParallelIterator(mut Square)::into_par_iter [rust]");
...
impl<'a> SquareMut<'a> {
    ...
    where
        'a: 'b,
    {
        let _guard = trace_guard!("SquareMut::iter_mut [rust]");
        self.p.chunks_exact_mut(self.d)
    }
    #[inline]
    ...
    where
        'a: 'b,
    {
        let _guard = trace_guard!("SquareMut::par_iter_mut [rust]");
        rayon::slice::ParallelSliceMut::par_chunks_exact_mut(self.p, self.d)
    }
    #[inline]
    pub fn row(&self, i: usize) -> &[f32] {
        let _guard = trace_guard!("SquareMut::row [rust]");
        let d = self.d;
        &self.p[i * d..(i + 1) * d]
    }
    #[inline]
    pub fn row_mut(&mut self, i: usize) -> &mut [f32] {
        let _guard = trace_guard!("SquareMut::row_mut [rust]");
        let d = self.d;
        &mut self.p[i * d..(i + 1) * d]
    }
    pub fn copy_within<R: std::ops::RangeBounds<usize>>(&mut self, src: R, dest: usize) {
        let _guard = trace_guard!("SquareMut::copy_within [rust]");
        let src_start = src.start_bound().map(|x| self.d * x);
        let src_end = src.end_bound().map(|x| self.d * x);
        self.p.copy_within((src_start, src_end), self.d * dest);
    }
    ...
    pub fn into_inner(self) -> (usize, &'a mut [f32]) {
        let _guard = trace_guard!("SquareMut::into_inner [rust]");
        (self.d, self.p)
    }
}
...
impl std::ops::Index<usize> for SquareMut<'_> {
    ...
    fn index(&self, index: usize) -> &Self::Output {
        let _guard = trace_guard!("Index(SquareMut)::index [rust]");
        &self.p[self.d * index..][..self.d]
    }
}
...
impl std::ops::IndexMut<usize> for SquareMut<'_> {
    fn index_mut(&mut self, index: usize) -> &mut Self::Output {
        let _guard = trace_guard!("IndexMut(SquareMut)::index_mut [rust]");
        &mut self.p[self.d * index..][..self.d]
    }
}
...
impl<'a> IntoIterator for &'a mut SquareMut<'a> {
    ...
    fn into_iter(self) -> Self::IntoIter {
        let _guard = trace_guard!("IntoIterator(SquareMut)::into_iter [rust]");
        self.p.chunks_exact_mut(self.d)
    }
}
...
impl<'a> rayon::prelude::IntoParallelIterator for &'a mut SquareMut<'a> {
    ...
    fn into_par_iter(self) -> Self::Iter {
        let _guard = trace_guard!("IntoParallelIterator(SquareMut)::into_par_iter [rust]");
        rayon::slice::ParallelSliceMut::par_chunks_exact_mut(self.p, self.d)
    }
}

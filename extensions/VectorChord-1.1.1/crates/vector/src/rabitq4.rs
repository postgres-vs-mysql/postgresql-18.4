...
impl Rabitq4Owned {
    ...
    pub fn new(
        ...
        let _guard = trace_guard!("Rabitq4Owned::new [rust]");
        Self::new_checked(
            dim,
            sum_of_x2,
            norm_of_lattice,
    ...
    pub fn new_checked(
        ...
        let _guard = trace_guard!("Rabitq4Owned::new_checked [rust]");
    ...
    pub unsafe fn new_unchecked(
        ...
        let _guard = trace_guard!("Rabitq4Owned::new_unchecked [rust]");
        Self {
            dim,
            sum_of_x2,
            norm_of_lattice,
...
impl VectorOwned for Rabitq4Owned {
    ...
    fn as_borrowed(&self) -> Rabitq4Borrowed<'_> {
        let _guard = trace_guard!("VectorOwned(Rabitq4Owned)::as_borrowed [rust]");
        Rabitq4Borrowed {
            dim: self.dim,
...
impl<'a> Rabitq4Borrowed<'a> {
    ...
    pub fn new(
        ...
        let _guard = trace_guard!("Rabitq4Borrowed::new [rust]");
        Self::new_checked(
            dim,
            sum_of_x2,
            norm_of_lattice,
    ...
    pub fn new_checked(
        ...
        let _guard = trace_guard!("Rabitq4Borrowed::new_checked [rust]");
    ...
    pub unsafe fn new_unchecked(
        ...
        let _guard = trace_guard!("Rabitq4Borrowed::new_unchecked [rust]");
        Self {
            dim,
            sum_of_x2,
            norm_of_lattice,
    ...
    pub fn unpacked_code(&self) -> impl Iterator<Item = u8> {
        let _guard = trace_guard!("Rabitq4Borrowed::unpacked_code [rust]");
        self.packed_code
            .iter()
...
impl VectorBorrowed for Rabitq4Borrowed<'_> {
    ...
    fn operator_dot(self, rhs: Self) -> Distance {
        let _guard = trace_guard!("VectorBorrowed(Rabitq4Borrowed)::operator_dot [rust]");
        let dim = self.dim();
    ...
    fn operator_l2s(self, rhs: Self) -> Distance {
        let _guard = trace_guard!("VectorBorrowed(Rabitq4Borrowed)::operator_l2s [rust]");
        let dim = self.dim();
        let sum = rabitq::halfbyte::binary::accumulate(self.packed_code, rhs.packed_code);
        Distance::from_f32(
    ...
    fn operator_cos(self, rhs: Self) -> Distance {
        let _guard = trace_guard!("VectorBorrowed(Rabitq4Borrowed)::operator_cos [rust]");
        let dim = self.dim();
        let sum = rabitq::halfbyte::binary::accumulate(self.packed_code, rhs.packed_code);
        Distance::from_f32(
    ...
    fn function_normalize(&self) -> Rabitq4Owned {
        let _guard = trace_guard!("VectorBorrowed(Rabitq4Borrowed)::function_normalize [rust]");
        Rabitq4Owned {
            dim: self.dim,
            sum_of_x2: 1.0,
            norm_of_lattice: self.norm_of_lattice,

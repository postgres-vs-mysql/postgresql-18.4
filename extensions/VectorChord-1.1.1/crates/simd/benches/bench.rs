...
fn floating_f32_reduce_sum_of_xy(c: &mut Criterion) {
    let _guard = trace_guard!("floating_f32_reduce_sum_of_xy [rust]");
    use rand::RngExt;
...
fn floating_f32_reduce_sum_of_d2(c: &mut Criterion) {
    let _guard = trace_guard!("floating_f32_reduce_sum_of_d2 [rust]");
    use rand::RngExt;
    let mut rng = rand::rng();
    let x = (0..4095)
        .map(|_| rng.random_range(-1.0..=1.0f32))
...
fn floating_f16_reduce_sum_of_xy(c: &mut Criterion) {
    let _guard = trace_guard!("floating_f16_reduce_sum_of_xy [rust]");
    use rand::RngExt;
    use simd::{F16, f16};
    let mut rng = rand::rng();
    let x = (0..4095)
...
fn floating_f16_reduce_sum_of_d2(c: &mut Criterion) {
    let _guard = trace_guard!("floating_f16_reduce_sum_of_d2 [rust]");
    use rand::RngExt;
    use simd::{F16, f16};
    let mut rng = rand::rng();
    let x = (0..4095)
...
fn byte_reduce_sum_of_xy(c: &mut Criterion) {
    let _guard = trace_guard!("byte_reduce_sum_of_xy [rust]");
    use rand::RngExt;
    let mut rng = rand::rng();
...
fn byte_reduce_sum_of_x(c: &mut Criterion) {
    let _guard = trace_guard!("byte_reduce_sum_of_x [rust]");
    use rand::RngExt;
    let mut rng = rand::rng();
...
fn halfbyte_reduce_sum_of_xy(c: &mut Criterion) {
    let _guard = trace_guard!("halfbyte_reduce_sum_of_xy [rust]");
    use rand::RngExt;
    let mut rng = rand::rng();

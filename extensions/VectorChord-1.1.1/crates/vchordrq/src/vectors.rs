...
>(
    ...
    let _guard = trace_guard!("vchordrq::vectors::read [rust]");
...
{
    let _guard = trace_guard!("vchordrq::vectors::append [rust]");
    ...
    where
        R::Page: Page<Opaque = Opaque>,
    {
        let _guard = trace_guard!("vchordrq::vectors::append(internal) [rust]");

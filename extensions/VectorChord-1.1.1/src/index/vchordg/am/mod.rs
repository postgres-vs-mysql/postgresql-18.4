...
impl Reloption {
    ...
    pub unsafe fn ef_search(this: *const Self, default: i32) -> i32 {
        let _guard = trace_guard!("ef_search [rust]");
        unsafe {
            if this.is_null() {
                return default;
            }
...
pub fn init() {
    let _guard = trace_guard!("vchordg::mod::init [rust]");
...
fn _vchordg_amhandler(_fcinfo: pgrx::pg_sys::FunctionCallInfo) -> Internal {
    let _guard = trace_guard!("vchordg::mod::_vchordg_amhandler [rust]");
...
pub unsafe extern "C-unwind" fn amcostestimate(
    ...
    let _guard = trace_guard!("vchordg::mod::amcostestimate [rust]");
    unsafe {
...
pub unsafe extern "C-unwind" fn aminsert(
    ...
    let _guard = trace_guard!("vchordg::mod::aminsert [rust]");
...
unsafe fn aminsertinner(
    ...
    let _guard = trace_guard!("vchordg::mod::aminsertinner [rust]");
...
pub unsafe extern "C-unwind" fn ambulkdelete(
    ...
    let _guard = trace_guard!("vchordg::mod:ambulkdelete [rust]");
...
pub unsafe extern "C-unwind" fn amvacuumcleanup(
    ...
    let _guard = trace_guard!("vchordg::mod:amvacuumcleanup [rust]");
    let mut stats = stats;
    if stats.is_null() {
        stats = unsafe {
            pgrx::pg_sys::palloc0(size_of::<pgrx::pg_sys::IndexBulkDeleteResult>()).cast()
...
pub unsafe extern "C-unwind" fn amrescan(
    ...
    let _guard = trace_guard!("vchordg::mod::amrescan [rust]");
    unsafe {
        use crate::index::vchordg::opclass::Opfamily;
...
pub unsafe extern "C-unwind" fn amgettuple(
    ...
    let _guard = trace_guard!("vchordg::mod::amgettuple [rust]");
...
pub unsafe extern "C-unwind" fn amendscan(scan: pgrx::pg_sys::IndexScanDesc) {
    let _guard = trace_guard!("vchordg::mod::amendscan [rust]");

...
impl Default for VchordrqDefaultBuildOptions {
    fn default() -> Self {
        let _guard = trace_guard!("Default(VchordrqDefaultBuildOptions)::default [rust]");
        Self {}
    }
}
...
impl VchordrqInternalBuildOptions {
    ...
    fn validate_lists(lists: &[u32]) -> Result<(), ValidationError> {
        let _guard = trace_guard!("VchordrqInternalBuildOptions::validate_lists [rust]");
        if !lists.is_sorted() {
...
impl Default for VchordrqInternalBuildOptions {
    fn default() -> Self {
        let _guard = trace_guard!("Default(VchordrqInternalBuildOptions)::default [rust]");
        Self {
...
impl VchordrqExternalBuildOptions {
    fn validate_table(table: &str) -> Result<(), ValidationError> {
        let _guard = trace_guard!("VchordrqExternalBuildOptions::validate_table [rust]");
...
impl Default for VchordrqBuildSourceOptions {
    fn default() -> Self {
        let _guard = trace_guard!("Default(VchordrqBuildSourceOptions)::default [rust]");
...
impl Validate for VchordrqBuildSourceOptions {
    fn validate(&self) -> Result<(), ValidationErrors> {
        let _guard = trace_guard!("Validate(VchordrqBuildSourceOptions)::validate [rust]");
...
impl VchordrqBuildOptions {
    pub fn deserialize_pin<'de, D: serde::Deserializer<'de>>(
        ...
        let _guard = trace_guard!("VchordrqBuildOptions::deserialize_pin [rust]");
        #[derive(Deserialize)]
        #[serde(untagged)]
        enum Untagged {
            Bool(bool),

...
cb_loadTopologyByName(const LWT_BE_DATA* be, const char *name)
{
  ...
  DBUG_PRINT("postgis", "name:'%s'", name);
  ...
  if ( ! plan ) { /* prepare on first call */
    DBUG_PRINT("postgis", "prepare on first call:'%s'", sql);
  ...
  DBUG_PRINT("postgis", "cb_loadTopologyByName: topo '%s' has "
                 "id %d, srid %d, precision %g",
                 name, topo->id, topo->srid, topo->precision);
...
fillEdgeFields(LWT_ISO_EDGE* edge, HeapTuple row, TupleDesc rowdesc, int fields)
{
  ...
  DBUG_PRINT("postgis", "fillEdgeFields: got %d atts and fields %x",
                 rowdesc->natts, fields);
  ...
  if ( fields & LWT_COL_FACE_MBR ) {
    ...
    if ( ! isnull ) {
      ...
      if ( box ) {
        ...
        DBUG_PRINT("postgis", "Face %" LWTFMT_ELEMID " bbox xmin is %.15g", face->face_id, box->xmin);
...
cb_getEdgeById(const LWT_BE_TOPOLOGY *topo, const LWT_ELEMID *ids, uint64_t *numelems, int fields)
{
  ...
  DBUG_PRINT("postgis", "cb_getEdgeById query: %s", sql->data);
  ...
  DBUG_PRINT("postgis", "cb_getEdgeById: edge query returned " UINT64_FORMAT " rows", SPI_processed);
...
cb_getEdgeByNode(const LWT_BE_TOPOLOGY *topo, const LWT_ELEMID *ids, uint64_t *numelems, int fields)
{
  ...
  DBUG_PRINT("postgis", "cb_getEdgeByNode query: %s", sql->data);
  POSTGIS_DEBUGF(1, "data_changed is %d", topo->be_data->data_changed);
  DBUG_PRINT("postgis", "data_changed is %d", topo->be_data->data_changed);
  ...
  DBUG_PRINT("postgis", "cb_getEdgeByNode: edge query returned " UINT64_FORMAT " rows", SPI_processed);
  *numelems = SPI_processed;
...
cb_getEdgeByFace(const LWT_BE_TOPOLOGY *topo, const LWT_ELEMID *ids, uint64_t *numelems, int fields, const GBOX *box)
{
  ...
  DBUG_PRINT("postgis", "cb_getEdgeByFace query: %s", sql->data);
  POSTGIS_DEBUGF(1, "data_changed is %d", topo->be_data->data_changed);
  DBUG_PRINT("postgis", "data_changed is %d", topo->be_data->data_changed);
  ...
  DBUG_PRINT("postgis", "cb_getEdgeByFace: edge query returned %lu rows", SPI_processed);
  *numelems = SPI_processed;
...
cb_getFacesById(const LWT_BE_TOPOLOGY *topo, const LWT_ELEMID *ids, uint64_t *numelems, int fields)
{
  ...
  DBUG_PRINT("postgis", "cb_getFaceById query: %s", sql->data);
  POSTGIS_DEBUGF(1, "data_changed is %d", topo->be_data->data_changed);
  DBUG_PRINT("postgis", "data_changed is %d", topo->be_data->data_changed);
  ...
  DBUG_PRINT("postgis", "cb_getFaceById: face query returned %lu rows", SPI_processed);
  *numelems = SPI_processed;
...
cb_getRingEdges(const LWT_BE_TOPOLOGY *topo, LWT_ELEMID edge, uint64_t *numelems, int limit)
{
  ...
  DBUG_PRINT("postgis", "cb_getRingEdges query (limit %d): %s", limit, sql->data);
  ...
  DBUG_PRINT("postgis", "cb_getRingEdges: edge query returned %lu rows", SPI_processed);
  *numelems = SPI_processed;
  ...
  for ( i = 0; i < *numelems; ++i ) {
    ...
    DBUG_PRINT("postgis", "Component %lu in ring of edge %ld is edge %ld", i, edge, val);
    ...
    if ( i == *numelems - 1 ) {
      ...
      DBUG_PRINT("postgis", "Last component in ring of edge %ld"
                     " (%ld) has next_%s_edge %ld",
                     edge, val, sidetext, nextedge);
...
cb_getNodeById(const LWT_BE_TOPOLOGY *topo, const LWT_ELEMID *ids, uint64_t *numelems, int fields)
{
  ...
  DBUG_PRINT("postgis", "cb_getNodeById query: %s", sql->data);
  spi_result = SPI_execute(sql->data, !topo->be_data->data_changed, *numelems);
  MemoryContextSwitchTo( oldcontext ); /* switch back */
  ...
  DBUG_PRINT("postgis", "cb_getNodeById: edge query returned %lu rows", SPI_processed);
  *numelems = SPI_processed;
...
cb_getNodeByFace(const LWT_BE_TOPOLOGY *topo, const LWT_ELEMID *ids, uint64_t *numelems, int fields, const GBOX *box)
{
  ...
  DBUG_PRINT("postgis", "cb_getNodeByFace query: %s", sql->data);
  POSTGIS_DEBUGF(1, "data_changed is %d", topo->be_data->data_changed);
  DBUG_PRINT("postgis", "data_changed is %d", topo->be_data->data_changed);
  spi_result = SPI_execute(sql->data, !topo->be_data->data_changed, 0);
  MemoryContextSwitchTo( oldcontext ); /* switch back */
  ...
  DBUG_PRINT("postgis", "cb_getNodeByFace: edge query returned %lu rows", SPI_processed);
  *numelems = SPI_processed;
                           ...
                           int64_t limit)
{
  ...
  DBUG_PRINT("postgis", "cb_getEdgeWithinDistance2D: query is: %s", sql->data);
  ...
  if ( elems_requested == -1 ) {
    /* This was an EXISTS query */
    {
      ...
      *numelems = exists ? 1 : 0;
      ...
      DBUG_PRINT("postgis", "cb_getEdgeWithinDistance2D: exists ? " UINT64_FORMAT, *numelems);
    }
...
cb_insertNodes(const LWT_BE_TOPOLOGY *topo, LWT_ISO_NODE *nodes, uint64_t numelems)
{
  ...
  DBUG_PRINT("postgis", "cb_insertNodes query: %s", sql->data);
...
cb_insertEdges(const LWT_BE_TOPOLOGY *topo, LWT_ISO_EDGE *edges, uint64_t numelems)
{
  ...
  DBUG_PRINT("postgis", "cb_insertEdges query (" UINT64_FORMAT " elems): %s", numelems, sql->data);
  spi_result = SPI_execute(sql->data, false, numelems);
  MemoryContextSwitchTo( oldcontext ); /* switch back */
  ...
  DBUG_PRINT("postgis", "cb_insertEdges query processed " UINT64_FORMAT " rows", SPI_processed);
...
cb_insertFaces(const LWT_BE_TOPOLOGY *topo, LWT_ISO_FACE *faces, uint64_t numelems)
{
  ...
  DBUG_PRINT("postgis", "cb_insertFaces query (" UINT64_FORMAT " elems): %s", numelems, sql->data);
  spi_result = SPI_execute(sql->data, false, numelems);
  MemoryContextSwitchTo( oldcontext ); /* switch back */
  ...
  DBUG_PRINT("postgis", "cb_insertFaces query processed " UINT64_FORMAT " rows", SPI_processed);
                ...
                const LWT_ISO_EDGE* exc_edge, int exc_fields )
{
  ...
  DBUG_PRINT("postgis", "cb_updateEdges query: %s", sql->data);
  ...
  DBUG_PRINT("postgis", "cb_updateEdges: update query processed " UINT64_FORMAT " rows", SPI_processed);
                ...
                const LWT_ISO_NODE* exc_node, int exc_fields )
{
  ...
  DBUG_PRINT("postgis", "cb_updateNodes: %s", sql->data);
  ...
  DBUG_PRINT("postgis", "cb_updateNodes: update query processed " UINT64_FORMAT " rows", SPI_processed);
...
cb_updateNodesById(const LWT_BE_TOPOLOGY *topo, const LWT_ISO_NODE *nodes, uint64_t numnodes, int fields)
{
  ...
  DBUG_PRINT("postgis", "cb_updateNodesById query: %s", sql->data);
  ...
  DBUG_PRINT("postgis", "cb_updateNodesById: update query processed " UINT64_FORMAT " rows", SPI_processed);
                    ...
                    const LWT_ISO_FACE* faces, uint64_t numfaces )
{
  ...
  DBUG_PRINT("postgis", "cb_updateFacesById query: %s", sql->data);
  ...
  DBUG_PRINT("postgis", "cb_updateFacesById: update query processed " UINT64_FORMAT " rows", SPI_processed);
...
cb_updateEdgesById(const LWT_BE_TOPOLOGY *topo, const LWT_ISO_EDGE *edges, uint64_t numedges, int fields)
{
  ...
  DBUG_PRINT("postgis", "cb_updateEdgesById query: %s", sql->data);
  ...
  DBUG_PRINT("postgis", "cb_updateEdgesById: update query processed " UINT64_FORMAT " rows", SPI_processed);
                ...
                const LWT_ISO_EDGE* sel_edge, int sel_fields )
{
  ...
  DBUG_PRINT("postgis", "cb_deleteEdges: %s", sql->data);
  ...
  DBUG_PRINT("postgis", "cb_deleteEdges: delete query processed " UINT64_FORMAT " rows", SPI_processed);
                             ...
                             LWT_ELEMID split_edge, LWT_ELEMID new_edge1, LWT_ELEMID new_edge2 )
{
  ...
  DBUG_PRINT("postgis", "cb_updateTopoGeomEdgeSplit query: %s", sql->data);
  ...
  if ( spi_result == SPI_OK_DELETE_RETURNING && SPI_processed ) {
    ...
    DBUG_PRINT("postgis", "cb_updateTopoGeomEdgeSplit: deleted " UINT64_FORMAT " faces", SPI_processed);
  ...
  DBUG_PRINT("postgis", "cb_updateTopoGeomEdgeSplit: updated %d topogeoms", ntopogeoms);
                             ...
                             LWT_ELEMID split_face, LWT_ELEMID new_face1, LWT_ELEMID new_face2 )
{
  ...
  DBUG_PRINT("postgis", "cb_updateTopoGeomFaceSplit signalled "
                 "split of face %ld into %ld and %ld",
                 split_face, new_face1, new_face2);
  ...
  DBUG_PRINT("postgis", "cb_updateTopoGeomFaceSplit query: %s", sql->data);
  ...
  DBUG_PRINT("postgis", "cb_updateTopoGeomFaceSplit: updated %d topogeoms", ntopogeoms);
                          ...
                          LWT_ELEMID rem_edge, LWT_ELEMID face_left, LWT_ELEMID face_right )
{
  ...
  DBUG_PRINT("postgis", "cb_checkTopoGeomRemEdge query 1: %s", sql->data);
  ...
  if ( face_left != face_right ) {
    ...
    DBUG_PRINT("postgis", "Deletion of edge %ld joins faces %ld and %ld",
                   rem_edge, face_left, face_right);
    /*
    ...
    */
    ...
    DBUG_PRINT("postgis", "cb_checkTopoGeomRemEdge query 2: %s", sql->data);
    spi_result = SPI_execute(sql->data, !topo->be_data->data_changed, 0);
    MemoryContextSwitchTo( oldcontext ); /* switch back */
                             ...
                             LWT_ELEMID rem_edge )
{
  ...
  DBUG_PRINT("postgis", "cb_checkTopoGeomRemIsoEdge query 1: %s", sql->data);
                          ...
                          LWT_ELEMID rem_node, LWT_ELEMID edge1, LWT_ELEMID edge2 )
{
  ...
  DBUG_PRINT("postgis", "cb_checkTopoGeomRemNode query 1: %s", sql->data);
  ...
  DBUG_PRINT("postgis", "cb_checkTopoGeomRemNode query 2: %s", sql->data);
...
cb_checkTopoGeomRemIsoNode ( const LWT_BE_TOPOLOGY* topo, LWT_ELEMID rem_node )
{
  ...
  DBUG_PRINT("postgis", "cb_checkTopoGeomRemIsoNode query 2: %s", sql->data);
                            ...
                            LWT_ELEMID face1, LWT_ELEMID face2, LWT_ELEMID newface )
{
  ...
  if ( newface == face1 || newface == face2 ) {
    ...
    DBUG_PRINT("postgis", "cb_updateTopoGeomFaceHeal query: %s", sql->data);
    ...
    DBUG_PRINT("postgis", "cb_updateTopoGeomFaceHeal query 1: %s", sql->data);
    ...
    DBUG_PRINT("postgis", "cb_updateTopoGeomFaceHeal query 2: %s", sql->data);
                            ...
                            LWT_ELEMID edge1, LWT_ELEMID edge2, LWT_ELEMID newedge )
{
  ...
  if ( newedge == edge1 || newedge == edge2 ) {
    ...
    DBUG_PRINT("postgis", "cb_updateTopoGeomEdgeHeal query: %s", sql->data);
    ...
    DBUG_PRINT("postgis", "cb_updateTopoGeomEdgeHeal query 1: %s", sql->data);
    ...
    DBUG_PRINT("postgis", "cb_updateTopoGeomEdgeHeal query 2: %s", sql->data);
...
cb_getClosestEdge( const LWT_BE_TOPOLOGY* topo, const LWPOINT* pt, uint64_t *numedges, int fields )
{
  ...
  DBUG_PRINT("postgis", "cb_getClosestEdge query: %s", sql->data);
...
cb_computeFaceMBR(const LWT_BE_TOPOLOGY *topo, LWT_ELEMID face)
{
  ...
  DBUG_PRINT("postgis", "cb_computeFaceMBR query: %s", sql->data);
  spi_result = SPI_execute(sql->data, !topo->be_data->data_changed, 0);
  MemoryContextSwitchTo( oldcontext ); /* switch back */
  ...
  if ( box ) {
    ...
    DBUG_PRINT("postgis", "Face %" LWTFMT_ELEMID " bbox xmin is %.15g", face, box->xmin);
...
cb_deleteFacesById(const LWT_BE_TOPOLOGY *topo, const LWT_ELEMID *ids, uint64_t numelems)
{
  ...
  DBUG_PRINT("postgis", "cb_deleteFacesById query: %s", sql->data);
  ...
  DBUG_PRINT("postgis", "cb_deleteFacesById: delete query processed " UINT64_FORMAT " rows", SPI_processed);
...
cb_deleteNodesById(const LWT_BE_TOPOLOGY *topo, const LWT_ELEMID *ids, uint64_t numelems)
{
  ...
  DBUG_PRINT("postgis", "cb_deleteNodesById query: %s", sql->data);
  ...
  DBUG_PRINT("postgis", "cb_deleteNodesById: delete query processed " UINT64_FORMAT " rows", SPI_processed);
...
cb_getNodeWithinBox2D(const LWT_BE_TOPOLOGY *topo, const GBOX *box, uint64_t *numelems, int fields, int limit)
{
  ...
  DBUG_PRINT("postgis", "cb_getNodeWithinBox2D: query is: %s", sql->data);
  spi_result = SPI_execute(sql->data, !topo->be_data->data_changed, limit >= 0 ? limit : 0);
  MemoryContextSwitchTo( oldcontext ); /* switch back */
  ...
  if ( elems_requested == -1 ) {
    /* This was an EXISTS query */
    {
      ...
      *numelems = exists ? 1 : 0;
      ...
      DBUG_PRINT("postgis", "cb_getNodeWithinBox2D: exists ? " UINT64_FORMAT, *numelems);
    }
    return NULL;
  }
...
cb_getEdgeWithinBox2D(const LWT_BE_TOPOLOGY *topo, const GBOX *box, uint64_t *numelems, int fields, int limit)
{
  ...
  DBUG_PRINT("postgis", "cb_getEdgeWithinBox2D: query is: %s", sql->data);
  spi_result = SPI_execute(sql->data, !topo->be_data->data_changed, limit >= 0 ? limit : 0);
  MemoryContextSwitchTo( oldcontext ); /* switch back */
  ...
  if ( elems_requested == -1 ) {
    /* This was an EXISTS query */
    {
      ...
      *numelems = exists ? 1 : 0;
      ...
      DBUG_PRINT("postgis", "cb_getEdgeWithinBox2D: exists ? " UINT64_FORMAT, *numelems);
    }
    return NULL;
  }
...
cb_getFaceWithinBox2D(const LWT_BE_TOPOLOGY *topo, const GBOX *box, uint64_t *numelems, int fields, int limit)
{
  ...
  DBUG_PRINT("postgis", "cb_getFaceWithinBox2D: query is: %s", sql->data);
  spi_result = SPI_execute(sql->data, !topo->be_data->data_changed, limit >= 0 ? limit : 0);
  MemoryContextSwitchTo( oldcontext ); /* switch back */
  ...
  if ( elems_requested == -1 ) {
    /* This was an EXISTS query */
    {
      ...
      *numelems = exists ? 1 : 0;
      ...
      DBUG_PRINT("postgis", "cb_getFaceWithinBox2D: exists ? " UINT64_FORMAT, *numelems);
    }
...
xact_callback(XactEvent event, void *arg)
{
  ...
  DBUG_PRINT("postgis", "xact_callback called with event %d", event);
...
Datum ST_GetFaceEdges(PG_FUNCTION_ARGS)
{
  ...
  if (SRF_IS_FIRSTCALL()) {
    ...
    DBUG_PRINT("postgis", "lwt_GetFaceEdges returned %d", nelems);
    lwt_FreeTopology(topo);
  ...
  DBUG_PRINT("postgis", "ST_GetFaceEdges: cur:%d, val0:%s, val1:%s",
                 state->curr, values[0], values[1]);
...
Datum TopoGeo_AddLinestring(PG_FUNCTION_ARGS)
{
  ...
  POSTGIS_DEBUGF(1, "TopoGeo_AddLinestring: cur:%d, val:%" LWTFMT_ELEMID,
                 state->curr - 1, id);
  DBUG_PRINT("postgis", "TopoGeo_AddLinestring: cur:%d, val:%ld",
                 state->curr - 1, id);
...
Datum TopoGeo_AddPolygon(PG_FUNCTION_ARGS)
{
  ...
  POSTGIS_DEBUGF(1, "TopoGeo_AddPolygon: cur:%d, val:%" LWTFMT_ELEMID,
                 state->curr - 1, id);
  DBUG_PRINT("postgis", "TopoGeo_AddPolygon: cur:%d, val:%ld",
                 state->curr - 1, id);
...
Datum GetRingEdges(PG_FUNCTION_ARGS)
{
  ...
  DBUG_PRINT("postgis", "GetRingEdges: cur:%d, val:%ld",
                 state->curr - 1, edge_id);

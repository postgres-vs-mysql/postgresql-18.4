...
Datum LWGEOM_set_srid(PG_FUNCTION_ARGS)
{
  ...
  DBUG_PRINT("postgis", " setSRID(lwgeom, int4) :: lwgeom");
...
Datum LWGEOM_x_point(PG_FUNCTION_ARGS)
{
  ...
  DBUG_PRINT("postgis", "return X value of the point:%g", pt.x);
...
Datum LWGEOM_y_point(PG_FUNCTION_ARGS)
{
  ...
  DBUG_PRINT("postgis", "return Y value of the point:%g", pt.y);
...
Datum LWGEOM_z_point(PG_FUNCTION_ARGS)
{
  ...
  DBUG_PRINT("postgis", "return Z value of the point:%g", pt.z);
...
Datum LWGEOM_m_point(PG_FUNCTION_ARGS)
{
  ...
  DBUG_PRINT("postgis", "return M value of the point:%g", pt.m);
...
Datum LWGEOM_from_text(PG_FUNCTION_ARGS)
{
  ...
  DBUG_PRINT("postgis", "parse a WKT geometry string('%s') into an LWGEOM structure", wkt);
  ...
  if ( PG_NARGS() > 1 ) {
    DBUG_PRINT("postgis", "read user-requested SRID");
  ...
  DBUG_PRINT("postgis", "LWGEOM_from_text returns a geometry");

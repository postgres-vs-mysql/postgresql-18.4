 ...
 * liblwgeom versions
 */
#define LIBLWGEOM_VERSION "3.7.0dev"
#define LIBLWGEOM_VERSION_MAJOR "3"
#define LIBLWGEOM_VERSION_MINOR "7"
#define LIBLWGEOM_GEOS_VERSION "31201"
...
/**
* Determine whether a LWGEOM contains sub-geometries or not
* This basically just checks that the struct has geoms/ngeoms
* members, like all collections.
*/
...
*/
extern int lwgeom_has_rings(const LWGEOM *geom);
...
extern uint32_t lwcompound_num_curves(const LWCOMPOUND *compound);
...
*/
extern int lwgeom_parse_wkt(LWGEOM_PARSER_RESULT *parser_result, const char *wktstr, int parse_flags);
...
/* Utilities */
extern char *lwmessage_truncate(const char *str, int errpos, int maxlength);
...
* @param max_radius maximum radius of cluster before it's split
*/

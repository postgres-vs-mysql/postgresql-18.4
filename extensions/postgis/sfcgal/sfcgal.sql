...
RETURNS geometry
AS '$libdir/postgis_sfcgal-3', 'sfcgal_buffer3d'
LANGUAGE 'c' IMMUTABLE STRICT PARALLEL SAFE
COST 5000;
...
RETURNS geometry
AS '$libdir/postgis_sfcgal-3', 'sfcgal_straight_skeleton_partition'
LANGUAGE 'c' IMMUTABLE STRICT PARALLEL SAFE
COST 250;
...
RETURNS geometry
AS '$libdir/postgis_sfcgal-3', 'sfcgal_rotate_x'
LANGUAGE 'c' IMMUTABLE STRICT PARALLEL SAFE
COST 50;
...
RETURNS geometry
AS '$libdir/postgis_sfcgal-3', 'sfcgal_rotate_y'
LANGUAGE 'c' IMMUTABLE STRICT PARALLEL SAFE
COST 50;
...
RETURNS geometry
AS '$libdir/postgis_sfcgal-3', 'sfcgal_rotate_z'
LANGUAGE 'c' IMMUTABLE STRICT PARALLEL SAFE
COST 50;
...
RETURNS geometry
AS '$libdir/postgis_sfcgal-3', 'sfcgal_rotate'
LANGUAGE 'c' IMMUTABLE STRICT PARALLEL SAFE
COST 50;
...
RETURNS geometry
AS '$libdir/postgis_sfcgal-3', 'sfcgal_rotate_2d'
LANGUAGE 'c' IMMUTABLE STRICT PARALLEL SAFE
COST 50;
...
RETURNS geometry
AS '$libdir/postgis_sfcgal-3', 'sfcgal_rotate_3d'
LANGUAGE 'c' IMMUTABLE STRICT PARALLEL SAFE
COST 50;
...
RETURNS geometry
AS '$libdir/postgis_sfcgal-3', 'sfcgal_scale'
LANGUAGE 'c' IMMUTABLE STRICT PARALLEL SAFE
COST 50;
...
RETURNS geometry
AS '$libdir/postgis_sfcgal-3', 'sfcgal_scale_3d_around_center'
LANGUAGE 'c' IMMUTABLE STRICT PARALLEL SAFE
COST 50;
...
RETURNS geometry
AS '$libdir/postgis_sfcgal-3', 'sfcgal_scale_3d'
LANGUAGE 'c' IMMUTABLE STRICT PARALLEL SAFE
COST 50;
...
RETURNS geometry
AS '$libdir/postgis_sfcgal-3', 'sfcgal_translate_2d'
LANGUAGE 'c' IMMUTABLE STRICT PARALLEL SAFE
COST 50;
...
RETURNS geometry
AS '$libdir/postgis_sfcgal-3', 'sfcgal_translate_3d'
LANGUAGE 'c' IMMUTABLE STRICT PARALLEL SAFE
COST 50;
...
RETURNS geometry
AS '$libdir/postgis_sfcgal-3', 'sfcgal_simplify'
LANGUAGE 'c' IMMUTABLE STRICT PARALLEL SAFE
COST 50;
...
RETURNS geometry
AS '$libdir/postgis_sfcgal-3', 'sfcgal_alphawrapping_3d'
LANGUAGE 'c' IMMUTABLE STRICT PARALLEL SAFE
COST 50;

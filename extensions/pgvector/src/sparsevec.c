...
sparsevec_in(PG_FUNCTION_ARGS)
{
  ...
  DBUG_PRINT("pgvector", "convert textual representation to internal representation");
  maxNnz = 1;
...
sparsevec_out(PG_FUNCTION_ARGS)
{
  ...
  DBUG_PRINT("pgvector", "convert internal representation to textual representation");
  /*
   * Need:
   *
...
sparsevec_typmod_in(PG_FUNCTION_ARGS)
{
  ...
  DBUG_PRINT("pgvector", "convert type modifier");
...
sparsevec_recv(PG_FUNCTION_ARGS)
{
  ...
  DBUG_PRINT("pgvector", "convert external binary representation to internal representation");
...
sparsevec_send(PG_FUNCTION_ARGS)
{
  ...
  DBUG_PRINT("pgvector", "convert internal representation to the external binary representation");
  pq_begintypsend(&buf);
...
sparsevec(PG_FUNCTION_ARGS)
{
  ...
  DBUG_PRINT("pgvector", "convert sparse vector to sparse vector");
...
vector_to_sparsevec(PG_FUNCTION_ARGS)
{
  ...
  DBUG_PRINT("pgvector", "convert dense vector to sparse vector");
  CheckDim(dim);
  CheckExpectedDim(typmod, dim);
...
halfvec_to_sparsevec(PG_FUNCTION_ARGS)
{
  ...
  DBUG_PRINT("pgvector", "convert half vector to sparse vector");
  CheckDim(dim);
  CheckExpectedDim(typmod, dim);
...
array_to_sparsevec(PG_FUNCTION_ARGS)
{
  ...
  DBUG_PRINT("pgvector", "convert array to sparse vector");
...
SparsevecL2SquaredDistance(SparseVector * a, SparseVector * b)
{
  ...
  DBUG_PRINT("pgvector", "get the L2 squared distance between sparse vectors");
...
sparsevec_l2_distance(PG_FUNCTION_ARGS)
{
  ...
  result = sqrt((double) SparsevecL2SquaredDistance(a, b));
  DBUG_PRINT("pgvector", "get the L2 distance between sparse vectors:%g", result);
...
sparsevec_l2_squared_distance(PG_FUNCTION_ARGS)
{
  ...
  result = (double) SparsevecL2SquaredDistance(a, b);
  DBUG_PRINT("pgvector", "get the L2 squared distance between sparse vectors:%g", result);
...
sparsevec_inner_product(PG_FUNCTION_ARGS)
{
  ...
  result = (double) SparsevecInnerProduct(a, b);
  DBUG_PRINT("pgvector", "get the inner product of two sparse vectors:%g", result);
  PG_RETURN_FLOAT8(result);
}
...
sparsevec_negative_inner_product(PG_FUNCTION_ARGS)
{
  ...
  result = (double) - SparsevecInnerProduct(a, b);
  DBUG_PRINT("pgvector", "get the negative inner product of two sparse vectors:%g", result);
  PG_RETURN_FLOAT8(result);
}
...
sparsevec_cosine_distance(PG_FUNCTION_ARGS)
{
  ...
  DBUG_PRINT("pgvector", "get the cosine distance between two sparse vectors:%g", result);
  PG_RETURN_FLOAT8(result);
}
...
sparsevec_l1_distance(PG_FUNCTION_ARGS)
{
  ...
  DBUG_PRINT("pgvector", "get the L1 distance between two sparse vectors:%g", distance);
...
sparsevec_l2_norm(PG_FUNCTION_ARGS)
{
  ...
  result = sqrt(norm);
  DBUG_PRINT("pgvector", "get the L2 norm of a sparse vector:%g", result);
  PG_RETURN_FLOAT8(result);
}

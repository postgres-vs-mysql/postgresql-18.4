...
copy_plan_costsize(Plan *dest, Plan *src)
{
  ...
  DBUG_PRINT("timescaledb", "copy cost(startup_cost:%g, total_cost:%g) and size info from a lower plan node to an inserted node",
             dest->startup_cost, dest->total_cost);

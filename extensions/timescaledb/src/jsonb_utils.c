...
get_convert_func(Oid typeid)
{
  ...
  switch (typeid) {
    case INT2OID:
      DBUG_PRINT("timescaledb", "return int2_numeric for typeid:INT2OID");
      return int2_numeric;

    case INT4OID:
      DBUG_PRINT("timescaledb", "return int4_numeric for typeid:INT4OID");
      return int4_numeric;

    case INT8OID:
      DBUG_PRINT("timescaledb", "return int8_numeric for typeid:INT8OID");
      return int8_numeric;

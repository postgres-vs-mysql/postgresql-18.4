...
{
  DBUG_TRACE;
  DBUG_PRINT("timescaledb", "chunkd_id:%d", chunk_id);
  it->ctx.index = catalog_get_index(ts_catalog_get(),
                                    CHUNK_CONSTRAINT,
                                      ...
                                      const char *constraint_name)
{
  ...
  DBUG_PRINT("timescaledb", "chunk_id:%d, constraint_name:'%s'", chunk_id, constraint_name);
...
ts_chunk_constraint_scan_by_chunk_id(int32 chunk_id, Size num_constraints_hint, MemoryContext mctx)
{
  ...
  DBUG_PRINT("timescaledb", "chunk_id:%d, num_found:%d, num_constraints:%d", chunk_id, num_found, constraints->num_constraints);
    ...
    MemoryContext mctx)
{
  ...
  DBUG_PRINT("timescaledb", "dimension_slice_id:%d, count:%d", dimension_slice_id, count);
  return count;
}
    ...
    const Hypercube *cube)
{
  ...
  DBUG_PRINT("timescaledb", "chunk_id:%d, num_slices:%d", chunk_id, cube->num_slices);
    ...
    Oid table_id)
{
  ...
  DBUG_PRINT("timescaledb", "chunk_id:%d, hypertable_oid:%u, table_id:%u", chunk_id, hypertable_oid, table_id);
    ...
    const char chunk_relkind, Oid hypertable_oid)
{
  ...
  DBUG_PRINT("timescaledb", "chunk_id:%d, hypertable_oid:%u", chunk_id, hypertable_oid);
...
chunk_constraint_drop_constraint(TupleInfo *ti)
{
  ...
  DBUG_PRINT("timescaledb", "get the chunk relid:%u", chunk_relid);
    ...
    const char *hypertable_constraint_name)
{
  ...
  DBUG_PRINT("timescaledb", "chunk_id:%d, hypertable_constraint_name:'%s', count:%d", chunk_id, hypertable_constraint_name, count);
  return count;
}
...
ts_chunk_constraint_delete_by_constraint_name(int32 chunk_id, const char *constraint_name)
{
  ...
  DBUG_PRINT("timescaledb", "chunk_id:%d, constraint_name:'%s', count:%d", chunk_id, constraint_name, count);
  return count;
}
...
ts_chunk_constraint_delete_by_chunk_id(int32 chunk_id, ChunkConstraints *ccs, bool drop_constraint)
{
  ...
  DBUG_PRINT("timescaledb", "chunk_id:%d, count:%d", chunk_id, count);
  return count;
}
...
chunk_constraint_rename_on_chunk_table(int32 chunk_id, const char *old_name, const char *new_name)
{
  ...
  DBUG_PRINT("timescaledb", "chunk_id:%d, old_name:'%s', new_name:'%s'", chunk_id, old_name, new_name);
...
ts_chunk_constraint_update_slice_id(int32 chunk_id, int32 old_slice_id, int32 new_slice_id)
{
  ...
  DBUG_PRINT("timescaledb", "chunk_id:%d, old_slice_id:%d, new_slice_id:%d", chunk_id, old_slice_id, new_slice_id);
    ...
    const char *hypertable_constraint_name)
{
  ...
  DBUG_PRINT("timescaledb", "chunk_relid:%u, hypertable_constraint_name:'%s'", chunk_relid, hypertable_constraint_name);

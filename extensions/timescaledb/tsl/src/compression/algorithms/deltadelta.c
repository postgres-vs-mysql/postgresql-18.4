  ...
  switch (element_type) {
    case BOOLOID:
      *compressor = (ExtendedCompressor) {
        .base = deltadelta_bool_compressor
      };

      return &compressor->base;
    case INT2OID:
      *compressor = (ExtendedCompressor) {
        .base = deltadelta_uint16_compressor
      };

      return &compressor->base;
    case INT4OID:
      *compressor = (ExtendedCompressor) {
        .base = deltadelta_uint32_compressor
      };

      return &compressor->base;
    case INT8OID:
      *compressor = (ExtendedCompressor) {
        .base = deltadelta_uint64_compressor
      };

      return &compressor->base;
    case DATEOID:
      *compressor = (ExtendedCompressor) {
        .base = deltadelta_date_compressor
      };

      return &compressor->base;
    case TIMESTAMPOID:
      *compressor = (ExtendedCompressor) {
        .base = deltadelta_timestamp_compressor
      };
...
delta_delta_decompress_all(Datum compressed_data, Oid element_type, MemoryContext dest_mctx)
{
 ...
 switch (element_type) {
    case INT8OID:
      DBUG_PRINT("timescaledb", "element_type: INT8OID");
      break;
    case TIMESTAMPOID:
      DBUG_PRINT("timescaledb", "element_type: TIMESTAMPOID");
      break;
    case TIMESTAMPTZOID:
      DBUG_PRINT("timescaledb", "element_type: TIMESTAMPTZOID");
      break;
    case INT4OID:
      DBUG_PRINT("timescaledb", "element_type: INT4OID");
      break;
    case DATEOID:
      DBUG_PRINT("timescaledb", "element_type: DATEOID");
      break;
    case INT2OID:
      DBUG_PRINT("timescaledb", "element_type: INT2OID");
      break;
    default:
      break;
  }
  ...
  switch (element_type) {
    ...
    case TIMESTAMPOID:
    case TIMESTAMPTZOID:
      result = delta_delta_decompress_all_uint64(compressed_data, dest_mctx);
      break;

    case INT4OID:
    case DATEOID:
      result = delta_delta_decompress_all_uint32(compressed_data, dest_mctx);
      break;

    case INT2OID:
      result = delta_delta_decompress_all_uint16(compressed_data, dest_mctx);
      break;
  ...
  DBUG_PRINT("timescaledb", "ArrowArray's length:%ld", result->length);
  return result;
}
